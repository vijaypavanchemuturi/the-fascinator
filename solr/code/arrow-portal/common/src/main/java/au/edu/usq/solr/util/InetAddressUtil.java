...
public class InetAddressUtil {
     ...
     * {@link #contains} and should never have been made public. (And it's
     * inefficient and unnecessary too, as well as broken for IPv6. ;-) Use
     * <code>ip.getAddress()[partNumber]</code> instead.
     */
     ...
     * @deprecated This was an internal implementation detail of the method
     * {@link #contains} and should never have been made public. Furthermore
     * it's broken for IPv6. (However, there is no real replacement. If you need
     * this functionality, you should rewrite it yourself.)
     */
     ...
     * @deprecated This was an internal implementation detail of the method
     * {@link #contains} and should never have been made public. (And it's
     * unnecessary too, as well as broken for IPv6. ;-) Use
