...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
        ...
        // Add the canvas
        this.canvas = $('<div class="image-annotate-canvas"><img src="'+this.attr('src')+'" style="max-width: 100%; width: '+this.width()+'; display: block; position: absolute;"/><div class="image-annotate-view"></div><div class="image-annotate-edit"><div class="image-annotate-edit-area"></div></div></div>');
