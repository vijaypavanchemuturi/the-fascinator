...
public class OrganizationContact extends Contact {
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllOrg_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Affiliation.ORG, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllOrg_Inverse() {
		return Base.getAll_Inverse(this.model, Affiliation.ORG, this.getResource() );
	}
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllOrg_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Affiliation.ORG, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}



    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@6fb3d6 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@6fb3d6 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ClosableIterator<DataObject> getAllLogo(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, LOGO, DataObject.class);
	}
     ...
     */
	public static ReactorResult<DataObject> getAllLogo_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, LOGO, DataObject.class);
	}
     ...
     */
	public ClosableIterator<DataObject> getAllLogo() {
		return Base.getAll(this.model, this.getResource(), LOGO, DataObject.class);
	}
     ...
     */
	public ReactorResult<DataObject> getAllLogo_as() {
		return Base.getAll_as(this.model, this.getResource(), LOGO, DataObject.class);
	}
     ...
     */
	public static void addLogo(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataObject value) {
		Base.add(model, instanceResource, LOGO, value);
	}
     ...
     */
	public void addLogo(DataObject value) {
		Base.add(this.model, this.getResource(), LOGO, value);
	}
     ...
     */
	public static void setLogo(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataObject value) {
		Base.set(model, instanceResource, LOGO, value);
	}
     ...
     */
	public void setLogo(DataObject value) {
		Base.set(this.model, this.getResource(), LOGO, value);
	}
     ...
     */
	public static void removeLogo(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataObject value) {
		Base.remove(model, instanceResource, LOGO, value);
	}
     ...
     */
	public void removeLogo(DataObject value) {
		Base.remove(this.model, this.getResource(), LOGO, value);
	}
