 ...
 */
public class InvolvedPerson extends Thing {
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllInvolvedPerson_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, ID3Audio.INVOLVEDPERSON, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllInvolvedPerson_Inverse() {
		return Base.getAll_Inverse(this.model, ID3Audio.INVOLVEDPERSON, this.getResource() );
	}
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllInvolvedPerson_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, ID3Audio.INVOLVEDPERSON, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}



    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@21b7682d has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@21b7682d has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ClosableIterator<Contact> getAllInvolvedPersonContact(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, INVOLVEDPERSONCONTACT, Contact.class);
	}
     ...
     */
	public static ReactorResult<Contact> getAllInvolvedPersonContact_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, INVOLVEDPERSONCONTACT, Contact.class);
	}
     ...
     */
	public ClosableIterator<Contact> getAllInvolvedPersonContact() {
		return Base.getAll(this.model, this.getResource(), INVOLVEDPERSONCONTACT, Contact.class);
	}
     ...
     */
	public ReactorResult<Contact> getAllInvolvedPersonContact_as() {
		return Base.getAll_as(this.model, this.getResource(), INVOLVEDPERSONCONTACT, Contact.class);
	}
     ...
     */
	public static void addInvolvedPersonContact(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Contact value) {
		Base.add(model, instanceResource, INVOLVEDPERSONCONTACT, value);
	}
     ...
     */
	public void addInvolvedPersonContact(Contact value) {
		Base.add(this.model, this.getResource(), INVOLVEDPERSONCONTACT, value);
	}
     ...
     */
	public static void setInvolvedPersonContact(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Contact value) {
		Base.set(model, instanceResource, INVOLVEDPERSONCONTACT, value);
	}
     ...
     */
	public void setInvolvedPersonContact(Contact value) {
		Base.set(this.model, this.getResource(), INVOLVEDPERSONCONTACT, value);
	}
     ...
     */
	public static void removeInvolvedPersonContact(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Contact value) {
		Base.remove(model, instanceResource, INVOLVEDPERSONCONTACT, value);
	}
     ...
     */
	public void removeInvolvedPersonContact(Contact value) {
		Base.remove(this.model, this.getResource(), INVOLVEDPERSONCONTACT, value);
	}
	...
	public void removeAllInvolvedPersonContact() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@2dc9b4e7 has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@2dc9b4e7 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
