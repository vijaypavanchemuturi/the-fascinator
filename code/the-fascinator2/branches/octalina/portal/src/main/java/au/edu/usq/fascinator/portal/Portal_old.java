...
public class Portal_old implements Comparable<Portal> {
    ...
    public Portal_old(String name, String query) {
        this(name, name.substring(0, 1).toUpperCase() + name.substring(1),
                query);
    }

    public Portal_old(String name, String description, String query) {
        setName(name);
