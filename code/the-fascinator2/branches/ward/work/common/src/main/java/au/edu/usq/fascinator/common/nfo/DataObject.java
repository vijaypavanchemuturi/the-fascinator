...
public class DataObject extends Thing {
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Link' to this DataObject instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse1static] 
	 */
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllLink_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Bookmark.LINK, objectValue);
	}
	 ...
	 */
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllLink_Inverse() {
		return Base.getAll_Inverse(this.model, Bookmark.LINK, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'Link' to this DataObject instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse-as1static] 
	 */
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllLink_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Bookmark.LINK, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'HasMediaStream' to this DataObject instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse1static] 
	 */
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllHasMediaStream_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Media.HASMEDIASTREAM, objectValue);
	}
	 ...
	 * [Generated from RDFReactor template rule #getallinverse1dynamic] 
	 */
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllHasMediaStream_Inverse() {
		return Base.getAll_Inverse(this.model, Media.HASMEDIASTREAM, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'HasMediaStream' to this DataObject instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse-as1static] 
	 */
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllHasMediaStream_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Media.HASMEDIASTREAM, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}



    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@73cc11 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@73cc11 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ClosableIterator<DataContainer> getAllBelongsToContainer(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, BELONGSTOCONTAINER, DataContainer.class);
	}
     ...
     */
	public static ReactorResult<DataContainer> getAllBelongsToContainer_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, BELONGSTOCONTAINER, DataContainer.class);
	}
     ...
     */
	public ClosableIterator<DataContainer> getAllBelongsToContainer() {
		return Base.getAll(this.model, this.getResource(), BELONGSTOCONTAINER, DataContainer.class);
	}
     ...
     */
	public ReactorResult<DataContainer> getAllBelongsToContainer_as() {
		return Base.getAll_as(this.model, this.getResource(), BELONGSTOCONTAINER, DataContainer.class);
	}
     ...
     */
	public static void addBelongsToContainer(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataContainer value) {
		Base.add(model, instanceResource, BELONGSTOCONTAINER, value);
	}
     ...
     */
	public void addBelongsToContainer(DataContainer value) {
		Base.add(this.model, this.getResource(), BELONGSTOCONTAINER, value);
	}
     ...
     */
	public static void setBelongsToContainer(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataContainer value) {
		Base.set(model, instanceResource, BELONGSTOCONTAINER, value);
	}
     ...
     */
	public void setBelongsToContainer(DataContainer value) {
		Base.set(this.model, this.getResource(), BELONGSTOCONTAINER, value);
	}
     ...
     */
	public static void removeBelongsToContainer(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, DataContainer value) {
		Base.remove(model, instanceResource, BELONGSTOCONTAINER, value);
	}
     ...
     */
	public void removeBelongsToContainer(DataContainer value) {
		Base.remove(this.model, this.getResource(), BELONGSTOCONTAINER, value);
	}
