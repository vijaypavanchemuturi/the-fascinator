...
import au.edu.usq.fascinator.common.InetAddressUtil;
import au.edu.usq.fascinator.common.JsonConfig;
import au.edu.usq.fascinator.portal.Portal;
import au.edu.usq.fascinator.portal.Role;
import au.edu.usq.fascinator.portal.RoleList;
...
public class RoleManagerImpl implements RoleManager {
    ...
    public RoleManagerImpl(HttpServletRequest request) {
        this.request = request;
        try {
            config = new JsonConfig();
            portalsDir = new File(config.get("portal/home"));
    ...
    public List<Role> getUserRoles(String username, Portal portal) {
        ...
        try {
            ...
            if (nets != null && masks != null) {
                ...
                log.debug("No network address filter specified for " + portal);
            }
