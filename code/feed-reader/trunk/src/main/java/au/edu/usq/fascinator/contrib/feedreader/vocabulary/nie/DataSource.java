 ...
 */
public class DataSource extends Thing {

    /** http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataSource */
    @SuppressWarnings("hiding")
    public static final URI RDFS_CLASS = new URIImpl("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataSource",
            false);
     ...
     */
    protected DataSource(Model model,
            URI classURI,
     ...
     */
    public DataSource(Model model, String uriString, boolean write)
            throws ModelRuntimeException {
     ...
     */
    public static DataSource getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends DataSource> getAllInstances_as(
            Model model) {
        return Base.getAllInstances_as(model, RDFS_CLASS, DataSource.class);
    }

    /**
     * Remove rdf:type DataSource from this instance. Other triples are not
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as RDF resources, that have a relation 'DataSource' to
     *         this DataSource instance
     * 
     *         [Generated from RDFReactor template rule #getallinverse1static]
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllNepoDataSource_Inverse(
            Model model, Object objectValue) {
        return Base.getAll_Inverse(model, DataObject.DATASOURCE, objectValue);
    }
     ...
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllNepoDataSource_Inverse() {
        return Base.getAll_Inverse(this.model, DataObject.DATASOURCE, this
                .getResource());
    }
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as a ReactorResult, that have a relation 'DataSource' to
     *         this DataSource instance
     * 
     *         [Generated from RDFReactor template rule
     *         #getallinverse-as1static]
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllNepoDataSource_Inverse_as(
            Model model, Object objectValue) {
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as RDF resources, that have a relation 'RootElementOf' to
     *         this DataSource instance
     * 
     *         [Generated from RDFReactor template rule #getallinverse1static]
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllNepoRootElementOf_Inverse(
            Model model, Object objectValue) {
        return Base.getAll_Inverse(model,
                InformationElement.ROOTELEMENTOF,
                objectValue);
    }
     ...
     *         [Generated from RDFReactor template rule #getallinverse1dynamic]
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllNepoRootElementOf_Inverse() {
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as a ReactorResult, that have a relation 'RootElementOf'
     *         to this DataSource instance
     * 
     *         [Generated from RDFReactor template rule
     *         #getallinverse-as1static]
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllNepoRootElementOf_Inverse_as(
            Model model, Object objectValue) {
        return Base.getAll_Inverse_as(model,
                InformationElement.ROOTELEMENTOF,
                objectValue,
