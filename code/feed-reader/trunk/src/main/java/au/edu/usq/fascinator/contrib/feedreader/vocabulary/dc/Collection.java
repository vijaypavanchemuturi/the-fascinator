...
public class Collection extends Thing {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@332b9f79 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@332b9f79 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public void removeAllDcAccrualMethod() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@5b2eda6f has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@5b2eda6f has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
	...
	public void removeAllDcAccrualPeriodicity() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@bb82ef9 has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@bb82ef9 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
